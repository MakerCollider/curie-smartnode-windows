...
<p>The node represents the <strong>Analog Light Intensity</strong> module from the grove suite.</p>
...
<ol>Light intensity value(0~1023)</ol>

<h4 id="Usage"><strong>Usage</strong></h4>

<ol>
<li>Configure each parameter correctly.</li>
<li>When the <code>input</code> is 1，light sensor would be opeded.When <code>input</code> is 0，light sensor would be closed. </li>
