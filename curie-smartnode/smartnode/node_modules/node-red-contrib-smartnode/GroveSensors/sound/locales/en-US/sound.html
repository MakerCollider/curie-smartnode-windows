...
<p>The node represents the <strong>Sound Sensor</strong> module from the Grove suite.</p>
...
<ol>Sound intensity value(0~1023)</ol>

<h4 id="Usage"><strong>Usage</strong></h4>

<ol>
<li>Configure each parameter correctly.</li>
<li>When the <code>input</code> is 1, the node outputs current Sound sensor value every interval time. When the <code>input</code> is 0, stop outputing value.</li>
</ol>
</script>
