...
<script type="text/x-red" data-help-name="DFRotation">
<h3 id="Rotation node"><strong>Rotation Node</strong></h3>

<p>The node represents the <strong>Rotation Sensor</strong> from the DFRobot.</p>
...
<li>If <code>input</code> is 1，the node outputs current angle value every interval time. If <code>input</code> is 0，stop output.</li>
</ol>
</script>
