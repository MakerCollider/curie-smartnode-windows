...
<script type="text/x-red" data-help-name="DFTemperature">
<h3 id="Temperature node"><strong>Temperature Node</strong></h3>

<p>The node represents the <strong>Temperature Sensor</strong> from the DFRobot.</p>
...
<ol>Output Temperature Sensor value. 
...
<li>When the <code>input</code> is 1，the node outputs current Temperature sensor value every interval time. When the <code>input</code> is 0, stop the output.</li>
</ol>
</script>
